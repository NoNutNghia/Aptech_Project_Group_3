...
class VirusArticleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        VirusArticleModel::create([
            ...
            'type_id' => 1,
            'img' => 'Ebola/Ebola_virus_virion.jpg',
            'img_detail' => 'Ebola/481844255.0.0.jpg',
            'img_precaution' => 'Ebola/ebola-info.jpg',
            'description' => 'Ebola virus belongs to the genus Ebolavirus, capable of infecting and causing disease in humans, primates including monkeys, gorillas and chimpanzees. Several strains of the Ebolavirus family that are highly infectious in humans include Ebola, Sudan, Tai Forest and Bundibugyo viruses.'
        ]);

        VirusDetailModel::create([
            'location_of_origin' => 'Africa',

            'detail_description' => 'Ebola virus (EVD) is also known as Ebola hemorrhagic fever (EHF). EVD can cause an acute illness, dangerous to human health and has a very high mortality rate if not treated promptly. When infected with Ebola virus, the immune system and vital organs in the body will be attacked and severely damaged. In addition, it also reduces clotting factors, causing uncontrolled bleeding.
            Ebola first appeared in 1976, after two simultaneous outbreaks- one in Nzara, South Sudan and the other in Yambuku, DRC. The latter happened in a village near the Ebola River, so the disease was named after the river.
            ...
            'spread' => 'The researchers have shown that fruit bats of the family Pteropodidae are natural hosts for the Ebola virus. This virus enters the human body through close contact with the blood, secretions, organs or other bodily fluids of infected animals such as fruit bats, chimpanzees, gorillas, antelopes and antelopes. forest, the hedgehog is sick or dead.
            ...
            Ebola is transmitted from person to person through direct contact (through broken skin or mucous membranes in the eyes, nose, or mouth) with:
             - Blood or body fluids of someone who is sick or has died from Ebola.
             - Subjects have been contaminated with bodily fluids (such as blood, feces, vomit) from a person with Ebola or the body of a person who died of Ebola.
            ...
            Healthcare workers who are treating suspected or confirmed Ebola patients can also become infected through close contact with the patient. Infection prevention and control measures are not strictly followed.
            Furthermore, Ebola can be transmitted through burial rituals that directly involve the body of a person who has died from the disease.
            ...
            'precaution_required' => 'There is currently no vaccine and no specific treatment for Ebola.
            Don\'t travel to countries with Ebola outbreaks unnecessarily. Countries with Ebola outbreaks: Guinea, Liberia, Sierra Leone, Nigeria.
            If you have to go, you need to find out information about the Ebola epidemic situation at the destination to take measures to prevent infection for yourself.
            Maintain personal hygiene, wash hands frequently with soap and sanitizer.
            Avoid direct contact with blood, secretions, objects of people, animals infected with Ebola.
            Avoid direct contact with people who have Ebola. When needing to come into contact with sick people, they must wear a specialized mask, wear personal protective clothing properly and keep a distance when in contact.
            ...
            Regularly update information and ways to prevent Ebola from the Department of Preventive Medicine, the Ministry of Health on the website http://vncdc.gov.vn and other official information.'
        ]);
